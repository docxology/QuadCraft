...
## Overview
4D Space Invaders is a 4D browser-based game built on the QuadCraft engine.

## Quick Start
To play this game, run the following from the project root:

```bash
python3 games/run_games.py --game space_invaders
```
...
```bash
python3 games/run_games.py --test --game space_invaders
```
