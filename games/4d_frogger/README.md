...
## Overview
4D Frogger is a 4D browser-based game built on the QuadCraft engine.

## Quick Start
To play this game, run the following from the project root:

```bash
python3 games/run_games.py --game frogger
```
...
```bash
python3 games/run_games.py --test --game frogger
```
